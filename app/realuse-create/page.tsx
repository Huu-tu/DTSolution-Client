...
const RealuseCreatePage = () => {
    ...
    const submitHandler = async (e: any) => {
        ...
        try {
            const res = await fetch(`${process.env.PATH_URL_BACKEND}/api/solution`, {
                method: 'POST',
                body: formData,
            });
            ...
            console.error('Error uploading realuse:', err);
        }
    }
...
export default RealuseCreatePage;
